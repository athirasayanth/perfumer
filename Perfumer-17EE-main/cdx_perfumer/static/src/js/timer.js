...
export class TaskTimer extends Component {
    ...
    setup() {
        ...
        onWillStart(async () => {
            ...
            if (this.props.ongoing === undefined && !this.props.record.model.useSampleModel && this.props.record.data.task_timer) {
                const additionalDuration = await this.orm.call(this.props.record.resModel, 'get_working_duration', [this.props.record.resId]);
    ...
    async toggleFunction() {
        if (this.timerRunning) {
            ...
            this.timerRunning = false;
            await this.orm.call(this.props.record.resModel, 'action_toggle_start', [this.props.record.resId, this.timerRunning]);
